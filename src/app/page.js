...
const TRANSLATIONS = {
  tr: {
    ...
    onboardingStep1Desc: 'Adını, fotoğrafını ve rolünü profilinden güncel tut. Eksiksiz bir profil daha fazla iş getirir.',
  ...
  en: {
    ...
    onboardingStep1Desc: 'Keep your name, photo and role up to date in your profile. A complete profile brings more jobs.',
