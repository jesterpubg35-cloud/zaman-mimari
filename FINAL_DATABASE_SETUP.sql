-- =====================================================
-- TICK PLATFORM - FINAL DATABASE SETUP
-- Tarih: 29.04.2026
-- HATA DUZELTMELI: profilkisi.user_id text tipinde oldugu icin
--                   foreign key'ler kaldirildi
-- =====================================================
...
ADD COLUMN IF NOT EXISTS security_cleared_by TEXT,
...
-- =====================================================
-- 3. SECURITY_RADAR TABLOSUNU OLUSTUR (FOREIGN KEY'SIZ)
-- =====================================================
...
-- EKSİK FONKSİYON (Önce varsa sil, sonra oluştur)
